...
class KeepFitRealUITests: XCTestCase {
    ...
    func testEditUser() throws {
        ...
        tablesQuery/*@START_MENU_TOKEN@*/.otherElements["Height: 5' 10\""]/*[[".cells[\"Height: 5' 10\\\"\"].otherElements[\"Height: 5' 10\\\"\"]",".otherElements[\"Height: 5' 10\\\"\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        tablesQuery/*@START_MENU_TOKEN@*/.otherElements["Weight: 150 lbs"]/*[[".cells[\"Weight: 150 lbs\"].otherElements[\"Weight: 150 lbs\"]",".otherElements[\"Weight: 150 lbs\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        
        let tables1Query = XCUIApplication().tables
        tables1Query.children(matching: .other).element(boundBy: 3).children(matching: .other).element.swipeUp()
        tables1Query/*@START_MENU_TOKEN@*/.buttons["Complete User Update"]/*[[".cells[\"Complete User Update\"].buttons[\"Complete User Update\"]",".buttons[\"Complete User Update\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
